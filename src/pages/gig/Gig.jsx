    ...
    <div className="gig">
      <div className="container">
        <div className="left">
          ...
          <p> I use an AI program to create images based on text prompts. This
            ...
            <div className="reviws">
              ...
              <div className="item">
                <div className="user">
                  <img src="https://images.pexels.com/photos/1699159/pexels-photo-1699159.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" className="pp"/>
                  <div className="info">
                    <span>Houssem</span>
                    <div className="country">
                      <img src="https://upload.wikimedia.org/wikipedia/commons/c/ce/Flag_of_Tunisia.svg" alt="" />
                      <span>Tunisia</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="right">
            ...
            <p>I will create a unique high quality AI generated image based on description that you give me </p>
